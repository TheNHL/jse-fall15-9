...
database.users = [
	{id:0, username:'Person1', password: "123" },
	{id:1, username:'Person2', password: "456"},
	{id:2, username:'Person3', password: "789"}
];

database.tasks = [
// makes task appear on initial page. apparently a bug in the code?
//	{id:0, title:'Do some work', description:'Finish all // the things', creator:'Person1'}
];
